...
public class ReserveRoomTCPCommand extends AbstractTCPCommand {
  public int id;
  public int customer;
  ...
  public ReserveRoomTCPCommand( int pId, int pCustomer, String pLocation) {
    super();
    id = pId;
    customer = pCustomer;
    location = pLocation;
  ...
  public void doCommand() throws Exception {
    ...
    ReserveRoomTCPCommand mirror = (ReserveRoomTCPCommand) recv.readObject();
